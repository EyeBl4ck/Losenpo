...
async def comprar_contas(c: Client, m: CallbackQuery):
    ...
    total = f"{sum([int(x[1]) for x in contas])}" if contas else ""
...
<i>- Qual o tipo de logins que você deseja comprar?</i>

<b>🗂 | Há : {total} Logins disponíveis<b>
